...
set_target_properties(Trantor::Trantor PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libtrantor.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "c-ares::cares"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libtrantor.dll"
  )

list(APPEND _cmake_import_check_targets Trantor::Trantor )
list(APPEND _cmake_import_check_files_for_Trantor::Trantor "${_IMPORT_PREFIX}/lib/libtrantor.dll.a" "${_IMPORT_PREFIX}/bin/libtrantor.dll" )
