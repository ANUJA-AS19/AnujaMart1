...
RUN apt-get update && apt-get install -y build-essential cmake ninja-build git curl zip unzip tar pkg-config python3 bison flex autoconf automake libtool linux-libc-dev && rm -rf /var/lib/apt/lists/*
