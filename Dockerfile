...
RUN /opt/vcpkg/vcpkg install --triplet x64-linux-release --overlay-triplets=/opt/triplets || (cat /opt/vcpkg/buildtrees/libpqxx/install-x64-linux-release-rel-out.log || true; exit 1)
