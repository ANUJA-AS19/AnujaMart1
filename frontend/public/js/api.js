...
export const api = {
  ...
  createProduct: (input) => request('POST', EP.products, toWireProduct(input)),
  updateProduct: (id, input) => request('PUT', EP.product(id), toWireProduct(input)),
  deleteProduct: (id) => request('DELETE', EP.product(id)),
